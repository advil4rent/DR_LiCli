use decide_protocol::{
    ComponentName, ComponentRequest,
    proto::{ComponentParams, reply, Reply, StateChange},
...
pub async fn set_params(component: &str, params: Any) {
    ...
    let request = Request {
        ...
        component: Some(ComponentName::from(component)),
...
pub async fn set_state(component: &str, state: Any) {
